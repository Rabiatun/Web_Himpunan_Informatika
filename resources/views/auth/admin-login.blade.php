...
<div class="min-h-screen bg-gray-800 flex items-center justify-center py-12 px-4">
    <div class="bg-white rounded-lg shadow-md w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Panel administrasi HMIT UTS</p>
        </div>
        ...
        <form action="{{ route('admin.login', ['secret' => $secret]) }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-2">
                ...
                <x-password-input id="password" name="password" ringColor="gray" required />
            </div>

            <div class="text-right mb-6">
                <a href="{{ route('admin.forgot-password', ['secret' => $secret]) }}"
